...
function validacionContraseña(input) {
    return input === "secreto123" ? true : false
}
    ...
    if(window.confirm("Escogiste la opción:\n"+menu[opcionMenu-1]+"\n¿Desea continuar?")){
        ...
        switch (opcionMenu) {
            ...
            case 9:
                ...
                str = str+ "\nLa opción más usada fue: " + menu[usos.indexOf(Math.max(...usos))]+"\n"
                str = str+ "La opción menos usada fue: " + menu[usos.indexOf(Math.min(...usos))]+"\n"

                alert(str+"\nGracias. Refresca la página si desea volver al menú :)")
                break;
            default:
